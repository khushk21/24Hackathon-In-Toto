...
test_data=[[20,24,13,18,8,12],[5,7,10,6,8,9],[4.5,3.8,5.0,4.9,4.0,4.7],
...
def openingscreen():
    for widget in root.winfo_children():
        widget.forget()
    img=ImageTk.PhotoImage(Image.open("back.jpg"))
    open_message="Welcome to Amazoff"
    open_message_label = tk.Label(root, font='Calibri 45', fg="white", bg="black", text=open_message)
